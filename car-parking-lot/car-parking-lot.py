...
parser.add_argument("--model", type=str, default="yolo11l-park-obb.pt", help="YOLO11 OBB model")  # Path to the YOLO model
parser.add_argument("--video", type=str, default="inference/parking.mp4", help="Path to input video or webcam index (0)")  # Input video file or webcam
parser.add_argument("--conf", type=float, default=0.5, help="Confidence Threshold for detection")  # Confidence threshold for object detection
